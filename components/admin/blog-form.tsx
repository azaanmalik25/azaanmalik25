...
import { createBlogPost, updateBlogPost, getBlogPostById } from "@/lib/blog-service"
...
export function BlogForm({ postId }: BlogFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    excerpt: "",
    content: "",
    category: "Calculator Guides", // Updated default value
    calculator_id: "",
    tags: [] as string[],
    featured_image: "",
    is_published: false,
        ...
        try {
          ...
          if (post) {
            ...
            setFormData({
              ...
              category: post.category || "Calculator Guides", // Updated default value
              calculator_id: post.calculator_id || "",
              tags: post.tags || [],
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-2">
              ...
              <Button type="submit" form="blog-form" className="bg-purple-600 hover:bg-purple-700" disabled={loading}>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      maxLength={60}
                    />
                    <p className="text-sm text-gray-400 mt-1">{formData.meta_title.length}/60 characters</p>
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      maxLength={160}
                    />
                    <p className="text-sm text-gray-400 mt-1">{formData.meta_description.length}/160 characters</p>
                  </div>
            ...
            <div className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      {formData.is_published ? "This post will be published" : "This post will be saved as draft"}
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-900/50 border-gray-800">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <Label className="text-gray-300">Related Calculator</Label>
                    <Select
                      value={formData.calculator_id}
                      onValueChange={(value) => setFormData((prev) => ({ ...prev, calculator_id: value }))}
                    >
                      <SelectTrigger className="bg-gray-800 border-gray-700 text-white">
                        <SelectValue placeholder="Select calculator (optional)" />
                      </SelectTrigger>
                      <SelectContent>
